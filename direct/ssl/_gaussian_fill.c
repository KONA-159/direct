...
#define __pyx_kp_u_direct_ssl__gaussian_fill_pyx __pyx_string_tab[3]
...
#define __pyx_n_u_center_x __pyx_string_tab[9]
#define __pyx_n_u_center_y __pyx_string_tab[10]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[11]
#define __pyx_n_u_count __pyx_string_tab[12]
#define __pyx_n_u_direct_ssl__gaussian_fill __pyx_string_tab[13]
#define __pyx_n_u_dtype __pyx_string_tab[14]
#define __pyx_n_u_func __pyx_string_tab[15]
#define __pyx_n_u_gaussian_fill __pyx_string_tab[16]
#define __pyx_n_u_indx __pyx_string_tab[17]
#define __pyx_n_u_indy __pyx_string_tab[18]
...
#define __pyx_n_u_ncol __pyx_string_tab[25]
#define __pyx_n_u_nonzero_mask_count __pyx_string_tab[26]
#define __pyx_n_u_np __pyx_string_tab[27]
#define __pyx_n_u_nrow __pyx_string_tab[28]
#define __pyx_n_u_numpy __pyx_string_tab[29]
#define __pyx_n_u_output_mask __pyx_string_tab[30]
#define __pyx_n_u_pop __pyx_string_tab[31]
#define __pyx_n_u_qualname __pyx_string_tab[32]
#define __pyx_n_u_rnd_normal __pyx_string_tab[33]
...
#define __pyx_n_u_std_scale __pyx_string_tab[37]
#define __pyx_n_u_test __pyx_string_tab[38]
#define __pyx_n_u_values __pyx_string_tab[39]
#define __pyx_kp_b_iso88591_A_1_Rs_LPUUWWZZ_s_Qa_s_Qa_2S_uD __pyx_string_tab[40]
...
/* "direct/ssl/_gaussian_fill.pyx":30
 * 
 * 
...
static PyArrayObject *__pyx_f_6direct_3ssl_14_gaussian_fill_random_normal(double __pyx_v_mu_x, double __pyx_v_mu_y, double __pyx_v_std_x, double __pyx_v_std_y) {
  ...
  /* "direct/ssl/_gaussian_fill.pyx":42
 ...
 * 
*/
  __pyx_t_1 = __pyx_f_6direct_3ssl_14_gaussian_fill_random_uniform(); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 42, __pyx_L1_error)
  __pyx_v_r = sqrt((-2.0 * log(__pyx_t_1)));

  /* "direct/ssl/_gaussian_fill.pyx":43
 * 
 *     r = sqrt(-2 * log(random_uniform()))
 *     theta = 2 * pi * random_uniform()             # <<<<<<<<<<<<<<
 * 
...
*/
  __pyx_t_1 = __pyx_f_6direct_3ssl_14_gaussian_fill_random_uniform(); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 43, __pyx_L1_error)
  __pyx_v_theta = ((2.0 * M_PI) * __pyx_t_1);

  /* "direct/ssl/_gaussian_fill.pyx":45
 *     theta = 2 * pi * random_uniform()
 * 
 *     x = mu_x + r * cos(theta) * std_x             # <<<<<<<<<<<<<<
...
*/
  ...
  /* "direct/ssl/_gaussian_fill.pyx":46
 * 
 *     x = mu_x + r * cos(theta) * std_x
 *     y = mu_y + r * sin(theta) * std_y             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* "direct/ssl/_gaussian_fill.pyx":48
 *     y = mu_y + r * sin(theta) * std_y
 * 
 *     return np.array([x, y], dtype=float)             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_6 = PyFloat_FromDouble(__pyx_v_y); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_7 = PyList_New(2); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_GIVEREF(__pyx_t_4);
  if (__Pyx_PyList_SET_ITEM(__pyx_t_7, 0, __pyx_t_4) != (0)) __PYX_ERR(0, 48, __pyx_L1_error);
  __Pyx_GIVEREF(__pyx_t_6);
  if (__Pyx_PyList_SET_ITEM(__pyx_t_7, 1, __pyx_t_6) != (0)) __PYX_ERR(0, 48, __pyx_L1_error);
  __pyx_t_4 = 0;
  __pyx_t_6 = 0;
  __pyx_t_8 = 1;
...
/* "direct/ssl/_gaussian_fill.pyx":51
 * 
 * 
 * def gaussian_fill(             # <<<<<<<<<<<<<<
...
static PyMethodDef __pyx_mdef_6direct_3ssl_14_gaussian_fill_1gaussian_fill = {"gaussian_fill", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_6direct_3ssl_14_gaussian_fill_1gaussian_fill, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6direct_3ssl_14_gaussian_fill_1gaussian_fill(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_nonzero_mask_count,&__pyx_mstate_global->__pyx_n_u_nrow,&__pyx_mstate_global->__pyx_n_u_ncol,&__pyx_mstate_global->__pyx_n_u_center_x,&__pyx_mstate_global->__pyx_n_u_center_y,&__pyx_mstate_global->__pyx_n_u_std_scale,&__pyx_mstate_global->__pyx_n_u_mask,&__pyx_mstate_global->__pyx_n_u_output_mask,&__pyx_mstate_global->__pyx_n_u_seed,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "gaussian_fill", 0) < (0)) __PYX_ERR(0, 51, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 9; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("gaussian_fill", 1, 9, 9, i); __PYX_ERR(0, 51, __pyx_L3_error) }
      }
    ...
    __pyx_v_nonzero_mask_count = __Pyx_PyLong_As_int(values[0]); if (unlikely((__pyx_v_nonzero_mask_count == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 52, __pyx_L3_error)
    __pyx_v_nrow = __Pyx_PyLong_As_int(values[1]); if (unlikely((__pyx_v_nrow == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 53, __pyx_L3_error)
    __pyx_v_ncol = __Pyx_PyLong_As_int(values[2]); if (unlikely((__pyx_v_ncol == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 54, __pyx_L3_error)
    __pyx_v_center_x = __Pyx_PyLong_As_int(values[3]); if (unlikely((__pyx_v_center_x == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 55, __pyx_L3_error)
    __pyx_v_center_y = __Pyx_PyLong_As_int(values[4]); if (unlikely((__pyx_v_center_y == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_std_scale = __Pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_std_scale == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 57, __pyx_L3_error)
    __pyx_v_mask = ((PyArrayObject *)values[6]);
    __pyx_v_output_mask = ((PyArrayObject *)values[7]);
    __pyx_v_seed = __Pyx_PyLong_As_int(values[8]); if (unlikely((__pyx_v_seed == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 60, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("gaussian_fill", 1, 9, 9, __pyx_nargs); __PYX_ERR(0, 51, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_mask), __pyx_mstate_global->__pyx_ptype_5numpy_ndarray, 1, "mask", 0))) __PYX_ERR(0, 58, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_output_mask), __pyx_mstate_global->__pyx_ptype_5numpy_ndarray, 1, "output_mask", 0))) __PYX_ERR(0, 59, __pyx_L1_error)
...
static PyObject *__pyx_pf_6direct_3ssl_14_gaussian_fill_gaussian_fill(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_nonzero_mask_count, int __pyx_v_nrow, int __pyx_v_ncol, int __pyx_v_center_x, int __pyx_v_center_y, double __pyx_v_std_scale, PyArrayObject *__pyx_v_mask, PyArrayObject *__pyx_v_output_mask, int __pyx_v_seed) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("gaussian_fill", 0);
  ...
  __pyx_pybuffernd_output_mask.rcbuffer = &__pyx_pybuffer_output_mask;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_mask.rcbuffer->pybuffer, (PyObject*)__pyx_v_mask, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int64_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 51, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_output_mask.rcbuffer->pybuffer, (PyObject*)__pyx_v_output_mask, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int64_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 51, __pyx_L1_error)
  }
  ...
  /* "direct/ssl/_gaussian_fill.pyx":65
...
*/
  ...
  /* "direct/ssl/_gaussian_fill.pyx":69
 *     count = 0
 * 
 *     while count <= nonzero_mask_count:             # <<<<<<<<<<<<<<
 * 
...
*/
  while (1) {
    ...
    /* "direct/ssl/_gaussian_fill.pyx":71
 *     while count <= nonzero_mask_count:
 * 
 *         rnd_normal = random_normal(center_x, center_y, (nrow - 1) / std_scale, (ncol - 1) / std_scale)             # <<<<<<<<<<<<<<
 * 
...
*/
    __pyx_t_2 = ((PyObject *)__pyx_f_6direct_3ssl_14_gaussian_fill_random_normal(__pyx_v_center_x, __pyx_v_center_y, (((double)(__pyx_v_nrow - 1)) / __pyx_v_std_scale), (((double)(__pyx_v_ncol - 1)) / __pyx_v_std_scale))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 71, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    {
      __Pyx_BufFmt_StackElem __pyx_stack[1];
    ...
    /* "direct/ssl/_gaussian_fill.pyx":73
 *         rnd_normal = random_normal(center_x, center_y, (nrow - 1) / std_scale, (ncol - 1) / std_scale)
 * 
 *         indx = int(rnd_normal[0])             # <<<<<<<<<<<<<<
...
*/
    ...
    /* "direct/ssl/_gaussian_fill.pyx":74
 * 
 *         indx = int(rnd_normal[0])
 *         indy = int(rnd_normal[1])             # <<<<<<<<<<<<<<
 * 
...
*/
    ...
    /* "direct/ssl/_gaussian_fill.pyx":76
 *         indy = int(rnd_normal[1])
 * 
 *         if 0 <= indx < nrow and 0 <= indy < ncol and mask[indx, indy] == 1 and output_mask[indx, indy] != 1:             # <<<<<<<<<<<<<<
...
*/
    ...
    __pyx_t_8 = ((*__Pyx_BufPtrCContig2d(__pyx_t_5numpy_int64_t *, __pyx_pybuffernd_mask.rcbuffer->pybuffer.buf, __pyx_t_7, __pyx_pybuffernd_mask.diminfo[0].strides, __pyx_t_9, __pyx_pybuffernd_mask.diminfo[1].strides)) == 1);
    if (__pyx_t_8) {
    } else {
      __pyx_t_1 = __pyx_t_8;
      goto __pyx_L6_bool_binop_done;
    ...
    __pyx_t_8 = ((*__Pyx_BufPtrCContig2d(__pyx_t_5numpy_int64_t *, __pyx_pybuffernd_output_mask.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_output_mask.diminfo[0].strides, __pyx_t_7, __pyx_pybuffernd_output_mask.diminfo[1].strides)) != 1);
    __pyx_t_1 = __pyx_t_8;
    __pyx_L6_bool_binop_done:;
    if (__pyx_t_1) {

      /* "direct/ssl/_gaussian_fill.pyx":77
 * 
 *         if 0 <= indx < nrow and 0 <= indy < ncol and mask[indx, indy] == 1 and output_mask[indx, indy] != 1:
 *             output_mask[indx, indy] = 1             # <<<<<<<<<<<<<<
 *             count = count + 1
...
*/
      __pyx_t_7 = __pyx_v_indx;
      __pyx_t_9 = __pyx_v_indy;
      *__Pyx_BufPtrCContig2d(__pyx_t_5numpy_int64_t *, __pyx_pybuffernd_output_mask.rcbuffer->pybuffer.buf, __pyx_t_7, __pyx_pybuffernd_output_mask.diminfo[0].strides, __pyx_t_9, __pyx_pybuffernd_output_mask.diminfo[1].strides) = 1;

      /* "direct/ssl/_gaussian_fill.pyx":78
 *         if 0 <= indx < nrow and 0 <= indy < ncol and mask[indx, indy] == 1 and output_mask[indx, indy] != 1:
 *             output_mask[indx, indy] = 1
 *             count = count + 1             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* "direct/ssl/_gaussian_fill.pyx":80
 *             count = count + 1
 * 
 *     return output_mask             # <<<<<<<<<<<<<<
*/
...
__Pyx_RefNannySetupContext("PyInit__gaussian_fill", 0);
  ...
  }
  {
    ...
    if (!PyDict_GetItemString(modules, "direct.ssl._gaussian_fill")) {
      if (unlikely((PyDict_SetItemString(modules, "direct.ssl._gaussian_fill", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "direct/ssl/_gaussian_fill.pyx":21
...
*/
  ...
  /* "direct/ssl/_gaussian_fill.pyx":27
 ...
 *     int nrow,
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_6direct_3ssl_14_gaussian_fill_1gaussian_fill, 0, __pyx_mstate_global->__pyx_n_u_gaussian_fill, NULL, __pyx_mstate_global->__pyx_n_u_direct_ssl__gaussian_fill, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_gaussian_fill, __pyx_t_2) < (0)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{1},{179},{8},{29},{39},{34},{20},{5},{18},{8},{8},{18},{5},{25},{5},{8},{13},{4},{4},{13},{5},{8},{4},{10},{8},{4},{18},{2},{4},{5},{11},{3},{12},{10},{4},{12},{10},{9},{8},{6},{166}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 